...
void Model::createModelFSM()
{
    ...
    GameStep * FSMTempMatrix[STATE_COUNT][EVENT_COUNT] = //Creamos matriz temporal para luego copiar a la final
    {
        ...
        {idle,                  idle,                   idle,               waitingSecondAction,   waitingFirstAction,     idle,                idle,                idle,                idle,                idle,                    waitingResponse,     waitingResponse,     idle,                idle,                waitingFirstAction,  idle,                 idle,                   idle,                   playAgain,           playAgain,           waitingFirstAction,     waitingFirstAction,    waitingFirstAction,     idle                }, //WAITING FOR FIRST ACTION
