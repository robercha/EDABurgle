...
typedef enum {
    VALID_TILE, INVALID_TILE, INVALID_ACTION, A_PASS, A_MOVE, A_PEEK, A_ADD_DICE_TO_SAFE,
    A_ROL_DICE_FOR_SAFE, A_SPEND_ACTIONS, A_HACK_COMPUTER, A_USE_HACK_TOKEN, A_OFFER_LOOT, 
    A_REQUEST_LOOT, A_PICKUP_LOOT, A_CREATE_ALARM, A_SPY_PATROL_DECK, A_PATROL_IS_TOP, 
    A_PATROL_IS_BOTTOM, A_PLACE_CROW_TOKEN, WIN, LOSE, ACCEPT, DECLINE, EVENT_COUNT
