...
//}
//
//bool Tiara::awakenCurse(location_t location, tileInfo_t* tileInfo)
//{
//	bool curse = false;
//	if(isGuardNearby(this->owner, tileInfo))
//		curse = true;
//	
//	return curse;
//}
...
//{
//	bool isGuard = false;
//	if(ownerTile->isTileValid(guard->getLocation, tileInfo)) //is tile valid se fija si la location que le mando es adyacente a la tile
//		isGuard = true;
//	
//	return isGuard;
//}
